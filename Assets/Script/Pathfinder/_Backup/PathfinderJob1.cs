...
//        NativeArray<Vector3> movementAllowedNative = new NativeArray<Vector3>(movementAllowed.Length, Allocator.TempJob);
//        for (int i = 0; i < movementAllowed.Length; i++) 
//        {
//            movementAllowedNative[i] = movementAllowed[i];
//        }
...
//        NativeQueue<Vector3> frontier = new NativeQueue<Vector3>(Allocator.TempJob);
//        frontier.Enqueue(initialPosition);

//        NativeHashMap<Vector3, Vector3>  came_from = new NativeHashMap<Vector3, Vector3>(1000, Allocator.TempJob);
//        came_from[initialPosition] = Vector3.zero;

//        bool PathFound = false;

//        //int iteration = 0;
//        NativeArray<PathData> pathDataArray = new NativeArray<PathData>(movementAllowed.Length, Allocator.TempJob);
//        while (frontier.Count > 0)
//        {
//            Vector3 current = frontier.Dequeue();
//            for (int i = 0; i < movementAllowed.Length; i++)
//            {
//                pathDataArray[i] = new PathData(PathFound);
//            }

//            var job = new CalculatePathJob_BreadthFirst()
//            {
//                pathDataArray = pathDataArray,
//                movementAllowed = movementAllowedNative,
//                current = current,
//                destination = destination,
//                agentsAreObstacle = agentsAreObstacle,
//                wallCoordinates = LevelManager.instance.native_WallCoordinates,
//                agentCoordinates = LevelManager.instance.native_AgentCoordinates,
//                came_from = came_from
//            };

//            JobHandle jobHandle = job.Schedule(movementAllowed.Length, 1);
//            jobHandle.Complete();

//            //TODO: doesn't seem to update the information
//            for (int i = 0; i < job.pathDataArray.Length; i++)
//            {
//                if (job.pathDataArray[i].NextIsValid)
//                {
//                    frontier.Enqueue(job.pathDataArray[i].next);
//                    came_from[job.pathDataArray[i].next] = current;
//                }

//                if (job.pathDataArray[i].PathFound) 
//                {
//                    PathFound = true;
//                    break;
//                } 
...
//        pathDataArray.Dispose();
//        movementAllowedNative.Dispose();
//        came_from.Dispose();
//        frontier.Dispose();
...
//                if (
//                    !LevelManager.instance.native_WallCoordinates.Contains(next) &&
...
//        {
//            return !LevelManager.instance.native_AgentCoordinates.Contains(next);
//        }
//        else 
//        {
//            return true;
